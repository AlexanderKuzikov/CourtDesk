...
| INFR-001 | **ENOTFOUND судовых субдоменов.** В live-данных 2 дела в error: `oblsud--perm.sudrf.ru`, `2.perm.msudrf.ru` — `getaddrinfo ENOTFOUND`. Похоже, субдомены ГАС «Правосудие» сменились. Проверить актуальность субдоменов в справочнике судов |
